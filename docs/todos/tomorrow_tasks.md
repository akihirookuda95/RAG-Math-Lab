...
- [ ] `docs/notes/2026-02-01_linear_algebra_basics.md` の **「2. 内積」→「3. コサイン類似度」** を通読
...
- [ ] `docs/notes/2026-02-01_linear_algebra_basics.md` の **「4. 手計算で確認」** を、途中式込みで自力で計算
  - [ ] $u=(1,2),\ v=(2,1)$
  - [ ] 内積 $v\cdot u$
  - [ ] ノルム $\|u\|,\ \|v\|$
  - [ ] コサイン類似度 $\cos\theta$
...
- [ ] `docs/notes/2026-02-01_linear_algebra_basics.md` の **「5. 射影」** を、途中式込みで手計算
